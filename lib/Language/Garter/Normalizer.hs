...
anf i (Tuple es l)      = error "fill this in"

anf i (GetItem e1 e2 l) = error "fill this in"
...
imm i (Tuple es l)      = error "fill this in"

imm i (GetItem e1 e2 l) = error "fill this in"
